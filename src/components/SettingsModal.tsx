...
export function SettingsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Supabase Configuration" maxWidth="max-w-lg">
      <div className="space-y-5">
        <div className="flex items-start gap-3 rounded-xl border border-sky-500/20 bg-sky-500/5 p-3 text-sm text-sky-200">
          ...
          <p>
            Enter your Supabase project URL and publishable key. These are pre-filled with
